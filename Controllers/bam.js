...
// 	Bam.deleteMany({}) // delete what was there
// 	.then(() => {
// 		Bam.insertMany(startBam) // insert seed data
// 		.then((bams) => {
// 			console.log(bams); //show us what we got
// 			res.redirect('/'); // go back to index with seed data inputted
// 		})
// 	})	
// });
